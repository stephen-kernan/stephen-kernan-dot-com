...
import { AspectRatio } from "@/types/ImageConfig";

## About me

I've been working as a software engineer since 2020, when a fantastic group of folks
gave me a chance after three years teaching myself to code.
...
<div className="mobile" style={{ marginBlock: "var(--intersection-spacing)" }}>
  <EasyImage url="/us.webp" aspectRatio={AspectRatio.SQUARE} />
</div>
